...
public partial class main : Node
{
    ...
    private PackedScene BlockingTerrain = (PackedScene)GD.Load("res://Terrain/BlockingTerrain.tscn");
    ...
    private void CreateTerrain()
    {
        ...
        {
            Node CurrentTerrain = BlockingTerrain.Instantiate();
            AddChild(CurrentTerrain);
            Area2D TerrainInstance = (Area2D)CurrentTerrain;
            TerrainInstance.GlobalPosition = new Vector2(300, 300);
            TerrainInstance.Scale = new Vector2(0.1f, 5);
        }
    }
