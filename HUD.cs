...
public partial class hud : CanvasLayer
{
    ...
    private void setupHud()
    {
        ...
        if (StoredData.CurrentSoldierNode.Character.CurrentTarget != null)
        {
            RichTextLabel Bearing = (RichTextLabel)GetNode("Bearing");
            Bearing.Text = "Bearing: " + GetTargetBearing().ToString();
            RichTextLabel Range = (RichTextLabel)GetNode("Range");
            Range.Text = "Range: " + GetRangeToTarget().ToString();
        }
    }
